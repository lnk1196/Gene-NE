...
try:
        ...
        app.layout = html.Div([
        html.H1('Gene-NE'),
        html.H3('Created by Lauren Kirsch and Dr. Chiquito Crasto'),
        ...
        html.A("Link to PubMed IDs", href='https://plot.ly', target="_blank"),
        html.H4('Texas Tech University Center for Biotechnology and Genomics')
        ])           
